...
contract CarteiraDeEstudante{
    ...
    uint data_contrato;
    uint data_expericacao=1654041600; //: Quarta-feira, 1 junho 2022 00:00:00
    ...
    constructor (
        ...
        string memory _instituicao ) public {
       
       require(contrato_ativo == false, "Esse contrato nõa está mais ativado");
